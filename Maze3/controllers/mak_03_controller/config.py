...
# ===========================================================================
SM_ENABLED = True               # Enabled with Marginal Correction limits
...
SM_TRUST_HIT_FRAC = 0.85        # Unconditionally accept corrections above this score
SM_MIN_HIT_FRAC = 0.65          # Min score required to accept any correction
SM_MARGINAL_MAX_CORR = 0.05     # m, max spatial shift allowed for marginal scores (prevents corridor slide)
