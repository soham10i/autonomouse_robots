...
GRID_CELLS = int(round(GRID_SIZE_M / GRID_RESOLUTION))   # 440 @ 0.025
...
SM_ENABLED = True               # RE-ENABLED, conservative.  Disabling it (teleop
                                ...
                                # (Maze1 looping bug; latent here too).  Aligning each
                                # scan to the map before integration keeps walls crisp
                                # AND de-drifts.  The earlier smear came from ACCEPTING
                                # large jumps; acceptance below is confident-AND-small only.
...
SM_MARGINAL_MAX_CORR = 0.05     # m, MAX spatial shift accepted for ANY correction -- a
                                ...
                                # association and is rejected (keep odom).  De-drift w/o jitter.
