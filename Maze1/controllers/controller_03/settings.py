...
ROBOT_HEIGHT = 0.35             # m, top of chassis/lidar
...
# ===========================================================================
GRID_RESOLUTION = 0.025         # m / cell (was 0.04 — finer map: sharper walls, accurate floating-wall footprints, better render)
...
AUX_MAX_RANGE = 1.5             # m, drop far/noisy depth pixels (was 2.0)
...
DEPTH_MARK_NEAR_WALL_CELLS = 3 # skip depth marks within this many cells of a
...
# hashed into a sparse voxel grid.
CLOUD_ENABLED = True
...
CLOUD_Z_MIN = -0.05            # m; floor for accumulation
CLOUD_Z_MAX = 1.20            # m; ceiling for accumulation
CLOUD_ACCUM_PERIOD_S = 0.25    # s; throttle accumulation
...
CLOUD_OBS_BLIND_CELLS = 3
CLOUD_OBS_TO_PLANNER = False    # feed projected 3D cloud into 2D navigation
...
RECOVERY_REVERSE_T = 4.5        # s; MAX straight reverse (=> ~0.90 m).  The
...
RECOVERY_SPIN_T = 1.8           # s (1.4 * 1.8 = 2.52 rad ~ 144°, enough to escape)
...
# blind zone).
RECOVERY_ROTATE_CLEAR = 0.14    # m; required wall clearance before turning
                                # (was 0.20 — too close to corridor width, robot
                                # barely reversed before spinning)
